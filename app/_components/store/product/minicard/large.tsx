...
function MinicardLarge({ product, onPress, invertTextColor = false }: MinicardLargeProps) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        <Text style={[styles.name, invertTextColor && styles.invertedTitle]} numberOfLines={1}>
          {cardData.name}
        </Text>
