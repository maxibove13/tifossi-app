...
### Step 4: Get Webhook Secret from MercadoPago

The webhook secret is **generated by MercadoPago**, not randomly created:

1. In the MercadoPago Developer Dashboard, go to **Your integrations**
2. Select your application
3. Go to **Webhooks > Configure notifications**
4. Enter your webhook URL: `https://your-domain.com/api/webhooks/mercadopago`
5. Select events: `payment`, `merchant_order`
6. Click **Save**
7. MercadoPago will generate a **Secret signature** (secret key)
8. Copy this secret key for `MP_WEBHOOK_SECRET`

**Important**: The secret is application-specific. Test and production applications have different secrets.
